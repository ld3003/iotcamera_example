...
int AAC2PES(TSPKG_SESSION *session,TsPes * tsaacpes, unsigned long Adudiopts);                                       //填写pes结构
int AAC2PES(TSPKG_SESSION *session,TsPes * tsaacpes,unsigned long Adudiopts,unsigned char *pData,int iDataSize);     //填写pes结构